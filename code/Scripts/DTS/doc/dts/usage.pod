...
=head1 SYNPOSIS
  ...
  $ dts call system/objects/example-dataset/rebuild contexts/example-dataset/zebrafish1
  
  # open app1
  $ dts invoke system/objects/app1/ui_open_qml system/contexts/example-dataset/zebrafish1
